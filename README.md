...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/microsoft-azure-pipelines/refs/heads/main/apis.yml)
...
#### Tags:
 ...
 - CI/CD, Pipelines, REST

#### Properties

- [Documentation](https://learn.microsoft.com/en-us/rest/api/azure/devops/pipelines/)
- [OpenAPI](https://dev.azure.com/{organization}/_apis/public/api)
...
- [Change Log](https://learn.microsoft.com/en-us/azure/devops/release-notes/features-timeline-released)
...
#### Tags:
 ...
 - Artifacts, Build, Continuous Integration, Definitions
...
#### Tags:
 ...
 - Approvals, Continuous Delivery, Deployment, Release
...
#### Tags:
 ...
 - Approvals, Checks, Governance, Security
...
- [GitHubRepository](https://github.com/MicrosoftDocs/azure-devops-docs)
